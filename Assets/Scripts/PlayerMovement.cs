...
public class PlayerMovement : MonoBehaviour
{
    ...
    [SerializeField] private Transform landingEffectPlacement;
    private Vector3 landingEffectLocation;
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            isGrounded = true;
            landingEffectLocation = new Vector3(landingEffectPlacement.position.x, landingEffectPlacement.position.y, 0);
            Instantiate(landingEffect, landingEffectLocation, Quaternion.identity);
